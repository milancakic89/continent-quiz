...
const LS = require('./includes/_LS');
const ResultButtons = require('./includes/_ResultButtons');
...
*/
buttonGoToHome.addEventListener('click', ResultButtons.goToHome);
homeButtonPlay.addEventListener('click', ResultButtons.jumpToLedderboard);
...
function getQuestionsList(){
    ...
    if(newGame.isOver() !== true && newGame.getCounter() !==5){
        ...
        let scoreToLs = newGame.getScore();

        LS.setLocalStorage(scoreToLs);
    }
}
